...
import { getWorkflow } from "./workflowsApi";
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <button
        ...
        className="text-xs text-muted hover:text-text px-4 py-2 text-left border-b border-border shrink-0"
      >
        ← Back to workflows
      </button>
